                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            ...
                            <small>Choose an option</small></h1>
                        <ol class="breadcrumb">
                            <li>
                            ...
                            <li class="active">
                                <i class="fa fa-file"></i> Managing Customer Order
                            </li>
                        </ol>
	...
	if( isset($_SESSION['userType']) == 5 && $mt != "")
	{
		if ($mt == "Supplier")
		{
			if (isset($_GET['quoteResID']))
			{
				...
				echo "<form method='POST' action='QuotationsList.php'><input type='hidden' name='custid' value='".$cid['CustomerID']."' style='width: 250px;'/><input type='hidden' name='custordid' value='".$cid['Cust_Order_ID']."' style='width: 250px;'/><input type='submit' name='acceptco' value='Reject Customer Order' style='width: 250px;'/></form>";
